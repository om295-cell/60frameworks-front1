...
export const FALLBACK_HOMEPAGE_CONTENT = {
  ...
  clients: {
    eyebrow_en: 'TRUSTED BY INDUSTRY TITANS',
    eyebrow_ar: 'ثقة كبرى الكيانات والرواد',
    heading_en: 'Trusted by Sovereign Entities & Global Enterprises.',
    heading_ar: 'شركاء النجاح للهيئات السيادية والمؤسسات العالمية.',
    subtitle_en: 'We architect experiences for organizations where precision, security, and world-class prestige are non-negotiable.',
    subtitle_ar: 'نصنع الفعاليات للجهات التي تضع الدقة الفائقة والأمان المطلق والهيبة العالمية في صدارة أولوياتها.',
  },
  sectors: {
