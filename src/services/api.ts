...
export const FALLBACK_HOMEPAGE_CONTENT = {
  ...
  about: {
    ...
    pillars: [
      ...
      },
      {
        ...
        desc_en: 'Grand visuals fade without narrative depth. We build inspiring plots that connect your brand\'s capabilities to the audience\'s ambitions and aspirations.',
  ...
  sectors: {
    ...
    capabilitiesHeading_en: 'Key Domain Capabilities',
    capabilitiesHeading_ar: 'أبرز القدرات التنفيذية في القطاع',
    ctaText_en: '',
    ctaText_ar: '',
  },
  caseStudies: {
...
export const FALLBACK_TESTIMONIALS: Testimonial[] = [
  {
    quote: 'ما ميّز العمل مع ستون إطار هو قدرتهم على فهم احتياجنا وتحويله إلى محتوى بصري وإعلامي يعكس هويتنا بدقة. فريق مرن، سريع، ويهتم بالتفاصيل من الفكرة حتى التنفيذ.',
    quote_ar: 'ما ميّز العمل مع ستون إطار هو قدرتهم على فهم احتياجنا وتحويله إلى محتوى بصري وإعلامي يعكس هويتنا بدقة. فريق مرن، سريع، ويهتم بالتفاصيل من الفكرة حتى التنفيذ.',
    authorName: 'عبدالعزيز السبيعي',
    authorName_ar: 'عبدالعزيز السبيعي',
    authorRole: 'مدير التسويق والاتصال المؤسسي',
    authorRole_ar: 'مدير التسويق والاتصال المؤسسي',
    rating: 5,
    order: 1,
  },
  {
    quote: 'في ستون إطار وجدنا شريكًا يتعامل مع المشروع كجزء من فريقنا، وليس كمجرد مزوّد خدمة. جودة التنفيذ وسرعة الاستجابة والاهتمام بالتفاصيل صنعت فرقًا واضحًا في المخرجات.',
    quote_ar: 'في ستون إطار وجدنا شريكًا يتعامل مع المشروع كجزء من فريقنا، وليس كمجرد مزوّد خدمة. جودة التنفيذ وسرعة الاستجابة والاهتمام بالتفاصيل صنعت فرقًا واضحًا في المخرجات.',
    authorName: 'نورة القحطاني',
    authorName_ar: 'نورة القحطاني',
    authorRole: 'مديرة الاتصال المؤسسي',
    authorRole_ar: 'مديرة الاتصال المؤسسي',
    rating: 5,
    order: 2,
  },
  {
    quote: 'من التخطيط إلى التنفيذ، كان العمل منظمًا وواضحًا، والأهم أن الفريق استطاع ترجمة أهدافنا إلى تجربة إبداعية لها حضور وأثر. تجربة نعتز بها ونتطلع لتكرارها.',
    quote_ar: 'من التخطيط إلى التنفيذ، كان العمل منظمًا وواضحًا، والأهم أن الفريق استطاع ترجمة أهدافنا إلى تجربة إبداعية لها حضور وأثر. تجربة نعتز بها ونتطلع لتكرارها.',
    authorName: 'فيصل الحربي',
    authorName_ar: 'فيصل الحربي',
    authorRole: 'مدير التسويق',
    authorRole_ar: 'مدير التسويق',
    rating: 5,
    order: 3,
  },
];
