...
export const translations: Translations = {
  ...
  trustGlobalReach: { en: 'Global Reach', ar: 'حضور عالمي' },
  trustGlobalDesc: { en: 'Active across 24+ Countries', ar: 'حضور في أكثر من 24 دولة' },
  trustAward: { en: 'Award-Winning', ar: 'جوائز دولية' },
  trustAwardDesc: { en: '18+ International Design Honors', ar: '+18 جائزة وتكريم دولي' },
  trustProtocol: { en: 'Sovereign Grade', ar: 'معايير سيادية' },
  trustProtocolDesc: { en: 'Diplomatic Protocol Certified', ar: 'اعتماد البروتوكول والمراسم الدبلوماسية' },
  ...
  aboutCta: { en: 'Explore Strategic Partnership', ar: 'استكشف الشراكة الاستراتيجية' },
